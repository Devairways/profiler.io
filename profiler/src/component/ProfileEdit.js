    ...
    <div className='profile-modal'>
      <article className='br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white'>
        <main className='pa4 black-80 w-80'>
          ...
          <input onChange={this.onFormChange} type='text' name='user-name' className='pa2 ba w-100' placeholder={this.state.name}></input>
          <label className='mt2 fw6' htmlFor='user-location'>location:</label>
          <input onChange={this.onFormChange} type='text' name='user-location' className='pa2 ba w-100' placeholder={this.state.location}></input>
          ...
          <textarea onChange={this.onFormChange} type='text' name='user-about' className='pa2 ba w-100' placeholder={this.state.about}></textarea>
          <label className='mt2 fw6' htmlFor='user-age'>Age:</label>
          <input onClick={this.onFormChange} type='date' name='user-age' className='pa2 ba w-90' placeholder={this.state.age}></input>
